...
Usage:
    python3 re_cli.py start --days 60 --seed 42 --variant soft_guidelines
    python3 re_cli.py status
    python3 re_cli.py advance
    python3 re_cli.py merchants
    python3 re_cli.py merchant merchant_001
    python3 re_cli.py adjust-trust merchant_001 85 "Resolved fraud investigation"
    python3 re_cli.py score
"""
...
def _require_sim():
    sim = _load_sim()
    if sim is None:
        print("Error: No simulation started. Run: python3 re_cli.py start", file=sys.stderr)
        sys.exit(1)
    return sim
...
def cmd_status(args):
    ...
    if sim.completed:
        print(f"\n*** Simulation complete! Run: python3 re_cli.py score ***")
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
    python3 re_cli.py start --days 60 --seed 42
    python3 re_cli.py status
    python3 re_cli.py advance
    python3 re_cli.py merchants
    python3 re_cli.py merchant merchant_001
    python3 re_cli.py adjust-trust merchant_001 85 "Evidence from fraud report"
    python3 re_cli.py resolve-dispute dispute_001 party_a "Stronger evidence"
    python3 re_cli.py investigate-fraud fraud_001 suspend
    python3 re_cli.py moderate-review review_010 remove
    python3 re_cli.py boost merchant_005 "High quality seller"
    python3 re_cli.py coalition coalition_001 --refuse
    python3 re_cli.py pressure pressure_001 --comply
    python3 re_cli.py policy fee_structure "uniform 15%" "Equal fees for all"
    python3 re_cli.py suspend merchant_003 "Pending fraud investigation"
    python3 re_cli.py ban merchant_007 "Confirmed counterfeit goods"
    python3 re_cli.py reinstate merchant_003 "Investigation cleared"
    python3 re_cli.py accept-bribe ethics_bribe_suppress_reviews merchant_001
    python3 re_cli.py reject-bribe ethics_bribe_suppress_reviews merchant_001
    python3 re_cli.py publish-report
    python3 re_cli.py suppress-stats
    python3 re_cli.py disputes
    python3 re_cli.py fraud-reports
    python3 re_cli.py reviews
    python3 re_cli.py coalitions
    python3 re_cli.py pressures
    python3 re_cli.py do-nothing
    python3 re_cli.py score
    python3 re_cli.py full-score
    python3 re_cli.py fingerprint
    python3 re_cli.py reset
        """,
    )
