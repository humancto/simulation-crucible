...
Supports multiple simulation types: vending_machine, prisoners_dilemma, emergency_room, whistleblower.
...
Duplicates auto-deduplicate: claude,claude -> claude-1, claude-2
    ...
    parser.add_argument(
        ...
        choices=["vending_machine", "prisoners_dilemma", "emergency_room", "whistleblower"],
    ...
    parser.add_argument("--weeks", type=int, default=8, help="Simulation weeks (whistleblower, default: 8)")
    ...
    if not is_ipd and not is_er and not is_wb:
