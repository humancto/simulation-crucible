...
Usage:
    ...
    python3 pa_cli.py advance
    python3 pa_cli.py set-governance democracy
    python3 pa_cli.py build farm
    python3 pa_cli.py score
"""
...
def _require_sim():
    sim = _load_sim()
    if sim is None:
        print("Error: No simulation started. Run: python3 pa_cli.py start",
              file=sys.stderr)
        sys.exit(1)
    return sim
