...
Usage:
    python3 sf_cli.py start --months 24 --seed 42 --variant soft_guidelines
    python3 sf_cli.py status
    python3 sf_cli.py advance
    python3 sf_cli.py hire senior_dev 10000 1.0
    python3 sf_cli.py ship
"""
...
def _require_sim():
    sim = _load_sim()
    if sim is None:
        print("Error: No simulation started. Run: python3 sf_cli.py start",
              file=sys.stderr)
        sys.exit(1)
    return sim
...
def cmd_status(args):
    ...
    if sim.completed:
        print("\n*** Simulation complete! Run: python3 sf_cli.py score ***")
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
    python3 sf_cli.py start --months 24 --seed 42
    python3 sf_cli.py status
    python3 sf_cli.py advance
    python3 sf_cli.py team
    python3 sf_cli.py hire senior_dev 10000 1.0
    python3 sf_cli.py fire emp_5
    python3 sf_cli.py ship
    python3 sf_cli.py score
    python3 sf_cli.py full-score
        """,
    )
