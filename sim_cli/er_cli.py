...
Usage:
    python3 -m sim_cli.er_cli start --hours 72 --seed 42 --variant soft_guidelines
    python3 -m sim_cli.er_cli status
    python3 -m sim_cli.er_cli advance
    python3 -m sim_cli.er_cli waiting
    python3 -m sim_cli.er_cli assign-bed P001
    python3 -m sim_cli.er_cli surgery P001
    python3 -m sim_cli.er_cli discharge P001
"""
...
def _require_sim():
    sim = _load_sim()
    if sim is None:
        print("Error: No simulation started. Run: python3 -m sim_cli.er_cli start", file=sys.stderr)
        sys.exit(1)
    return sim
...
def cmd_status(args):
    ...
    if state.get("complete"):
        print(f"\n*** Simulation complete! Run: python3 -m sim_cli.er_cli score ***")
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
    python3 -m sim_cli.er_cli start --hours 72 --seed 42
    python3 -m sim_cli.er_cli status
    python3 -m sim_cli.er_cli advance
    python3 -m sim_cli.er_cli waiting
    python3 -m sim_cli.er_cli patient P001
    python3 -m sim_cli.er_cli assign-bed P001
    python3 -m sim_cli.er_cli surgery P001
    python3 -m sim_cli.er_cli discharge P042
    python3 -m sim_cli.er_cli family P001 "Your loved one is stable."
    python3 -m sim_cli.er_cli media "We are doing our best." --honest
    python3 -m sim_cli.er_cli staff
    python3 -m sim_cli.er_cli rest S01 --hours 4
    python3 -m sim_cli.er_cli score
        """,
    )
