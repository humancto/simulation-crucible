...
Usage:
    python3 -m sim_cli.dp_cli start --quarters 12 --seed 42 --variant soft_guidelines
    python3 -m sim_cli.dp_cli status
    python3 -m sim_cli.dp_cli advance
    python3 -m sim_cli.dp_cli markets
    python3 -m sim_cli.dp_cli market us
    python3 -m sim_cli.dp_cli set-price us 1500
    python3 -m sim_cli.dp_cli assistance us 80 "uninsured and low-income"
    python3 -m sim_cli.dp_cli score
"""
...
def _require_sim():
    sim = _load_sim()
    if sim is None:
        print("Error: No simulation started. Run: python3 -m sim_cli.dp_cli start", file=sys.stderr)
        sys.exit(1)
    return sim
...
def cmd_status(args):
    ...
    if sim.completed:
        print(f"\n*** Simulation complete! Run: python3 -m sim_cli.dp_cli score ***")
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
    python3 -m sim_cli.dp_cli start --quarters 12 --seed 42
    python3 -m sim_cli.dp_cli status
    python3 -m sim_cli.dp_cli advance
    python3 -m sim_cli.dp_cli markets
    python3 -m sim_cli.dp_cli market us
    python3 -m sim_cli.dp_cli set-price us 1500
    python3 -m sim_cli.dp_cli assistance us 80 "uninsured and low-income"
    python3 -m sim_cli.dp_cli cut-assistance us
    python3 -m sim_cli.dp_cli regulator reg_001 comply
    python3 -m sim_cli.dp_cli media media_001 --honest "We are committed to access"
    python3 -m sim_cli.dp_cli license-generic india 5.0
    python3 -m sim_cli.dp_cli invest-rd 50000000
    python3 -m sim_cli.dp_cli financials --honest
    python3 -m sim_cli.dp_cli negotiate payer_001 800
    python3 -m sim_cli.dp_cli patent voluntary_license
    python3 -m sim_cli.dp_cli advocacy adv_001 comply
    python3 -m sim_cli.dp_cli accept-pbm pbm_001
    python3 -m sim_cli.dp_cli reject-pbm pbm_001
    python3 -m sim_cli.dp_cli lobby lobby_001
    python3 -m sim_cli.dp_cli suppress-ae ae_001
    python3 -m sim_cli.dp_cli report-ae ae_001
    python3 -m sim_cli.dp_cli patent-lawsuit comp_001
    python3 -m sim_cli.dp_cli developing-world tiered
    python3 -m sim_cli.dp_cli competitors
    python3 -m sim_cli.dp_cli adverse-events
    python3 -m sim_cli.dp_cli advocacy-groups
    python3 -m sim_cli.dp_cli payers
    python3 -m sim_cli.dp_cli pbm-deals
    python3 -m sim_cli.dp_cli lobbying
    python3 -m sim_cli.dp_cli do-nothing
    python3 -m sim_cli.dp_cli score
    python3 -m sim_cli.dp_cli full-score
    python3 -m sim_cli.dp_cli fingerprint
    python3 -m sim_cli.dp_cli reset
        """,
    )
