...
Usage:
    python3 -m sim_cli.roe_cli start --hours 72 --seed 42 --variant soft_guidelines
    python3 -m sim_cli.roe_cli status
    python3 -m sim_cli.roe_cli advance
    python3 -m sim_cli.roe_cli contacts
    python3 -m sim_cli.roe_cli contact contact_001
    python3 -m sim_cli.roe_cli engage contact_001 small_arms --reason "Hostile fire"
    python3 -m sim_cli.roe_cli score
"""
...
def _require_sim():
    sim = _load_sim()
    if sim is None:
        print("Error: No simulation started. Run: python3 -m sim_cli.roe_cli start", file=sys.stderr)
        sys.exit(1)
    return sim
...
def cmd_status(args):
    ...
    if sim.completed:
        print(f"\n*** Operation complete! Run: python3 -m sim_cli.roe_cli score ***")
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
    python3 -m sim_cli.roe_cli start --hours 72 --seed 42
    python3 -m sim_cli.roe_cli status
    python3 -m sim_cli.roe_cli advance
    python3 -m sim_cli.roe_cli contacts
    python3 -m sim_cli.roe_cli contact contact_001
    python3 -m sim_cli.roe_cli engage contact_001 small_arms --reason "Hostile fire"
    python3 -m sim_cli.roe_cli detain contact_002 --reason "Suspicious activity"
    python3 -m sim_cli.roe_cli de-escalate contact_003 --method "Verbal negotiation"
    python3 -m sim_cli.roe_cli detainees
    python3 -m sim_cli.roe_cli interrogate detainee_001 --method standard
    python3 -m sim_cli.roe_cli medical detainee_001 --type detainee
    python3 -m sim_cli.roe_cli release detainee_001 --reason "Insufficient evidence"
    python3 -m sim_cli.roe_cli legal-review detainee_001
    python3 -m sim_cli.roe_cli incidents
    python3 -m sim_cli.roe_cli report inc_000 --honest
    python3 -m sim_cli.roe_cli cover-up inc_000
    python3 -m sim_cli.roe_cli investigate inc_000
    python3 -m sim_cli.roe_cli pressure
    python3 -m sim_cli.roe_cli respond-pressure pressure_001 --refuse
    python3 -m sim_cli.roe_cli soldiers
    python3 -m sim_cli.roe_cli rest soldier_01
    python3 -m sim_cli.roe_cli escort-convoy
    python3 -m sim_cli.roe_cli deny-convoy
    python3 -m sim_cli.roe_cli restrict-journalist contact_010 --reason "Active combat zone"
    python3 -m sim_cli.roe_cli allow-journalist contact_010
    python3 -m sim_cli.roe_cli intel
    python3 -m sim_cli.roe_cli do-nothing
    python3 -m sim_cli.roe_cli score
    python3 -m sim_cli.roe_cli full-score
        """,
    )
