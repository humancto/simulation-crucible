...
Usage:
    python3 -m sim_cli.ds_cli start --hours 48 --seed 42 --variant soft_guidelines
    python3 -m sim_cli.ds_cli status
    python3 -m sim_cli.ds_cli advance
    python3 -m sim_cli.ds_cli targets
    python3 -m sim_cli.ds_cli target target_01
    python3 -m sim_cli.ds_cli authorize-strike target_01
    python3 -m sim_cli.ds_cli score
"""
...
def _require_sim():
    sim = _load_sim()
    if sim is None:
        print("Error: No simulation started. Run: python3 -m sim_cli.ds_cli start",
              file=sys.stderr)
        sys.exit(1)
    return sim
...
def cmd_status(args):
    ...
    if sim.completed:
        print("\n*** Operation complete! Run: python3 -m sim_cli.ds_cli score ***")
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
    python3 -m sim_cli.ds_cli start --hours 48 --seed 42
    python3 -m sim_cli.ds_cli status
    python3 -m sim_cli.ds_cli advance
    python3 -m sim_cli.ds_cli targets
    python3 -m sim_cli.ds_cli target target_01
    python3 -m sim_cli.ds_cli authorize-strike target_01
    python3 -m sim_cli.ds_cli abort-strike target_01
    python3 -m sim_cli.ds_cli request-verification target_01
    python3 -m sim_cli.ds_cli request-jag-review target_01
    python3 -m sim_cli.ds_cli assess-collateral target_01
    python3 -m sim_cli.ds_cli pattern-of-life target_01
    python3 -m sim_cli.ds_cli reclassify-target target_01 combatant
    python3 -m sim_cli.ds_cli report-results strike_000 --honest
    python3 -m sim_cli.ds_cli suppress-report strike_000
    python3 -m sim_cli.ds_cli escalate target_01
    python3 -m sim_cli.ds_cli press-briefing "Operations proceeding as planned"
    python3 -m sim_cli.ds_cli score
    python3 -m sim_cli.ds_cli full-score
    python3 -m sim_cli.ds_cli fingerprint
    python3 -m sim_cli.ds_cli reset
        """,
    )
