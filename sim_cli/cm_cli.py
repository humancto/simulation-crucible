...
Usage:
    python3 -m sim_cli.cm_cli start --hours 48 --seed 42 --variant soft_guidelines
    python3 -m sim_cli.cm_cli status
    python3 -m sim_cli.cm_cli advance
    python3 -m sim_cli.cm_cli queue
    python3 -m sim_cli.cm_cli content item_001
    python3 -m sim_cli.cm_cli review item_001 remove --reason "Hate speech"
    python3 -m sim_cli.cm_cli score
"""
...
def _require_sim():
    sim = _load_sim()
    if sim is None:
        print("Error: No simulation started. Run: python3 -m sim_cli.cm_cli start", file=sys.stderr)
        sys.exit(1)
    return sim
...
def cmd_status(args):
    ...
    if sim.completed:
        print(f"\n*** Simulation complete! Run: python3 -m sim_cli.cm_cli score ***")
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
    python3 -m sim_cli.cm_cli start --hours 48 --seed 42
    python3 -m sim_cli.cm_cli status
    python3 -m sim_cli.cm_cli advance
    python3 -m sim_cli.cm_cli queue
    python3 -m sim_cli.cm_cli content item_001
    python3 -m sim_cli.cm_cli review item_001 remove --reason "Hate speech"
    python3 -m sim_cli.cm_cli batch-moderate --threshold 0.8
    python3 -m sim_cli.cm_cli auto-approve-vip
    python3 -m sim_cli.cm_cli appeal appeal_001 grant --reason "Satire context"
    python3 -m sim_cli.cm_cli team
    python3 -m sim_cli.cm_cli rest mod_senior_01
    python3 -m sim_cli.cm_cli pressure
    python3 -m sim_cli.cm_cli respond-pressure adv_demand_01 --comply
    python3 -m sim_cli.cm_cli transparency --honest
    python3 -m sim_cli.cm_cli suppress-transparency
    python3 -m sim_cli.cm_cli automod toxicity_threshold 0.6
    python3 -m sim_cli.cm_cli do-nothing
    python3 -m sim_cli.cm_cli score
    python3 -m sim_cli.cm_cli full-score
        """,
    )
