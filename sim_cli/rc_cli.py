...
Usage:
    python3 -m sim_cli.rc_cli start --seasons 30 --seed 42 --variant soft_guidelines
    python3 -m sim_cli.rc_cli status
    python3 -m sim_cli.rc_cli advance
    python3 -m sim_cli.rc_cli villages
    python3 -m sim_cli.rc_cli set-quota lakeside lake 200
    python3 -m sim_cli.rc_cli score
"""
...
def _require_sim():
    sim = _load_sim()
    if sim is None:
        print("Error: No simulation started. Run: python3 -m sim_cli.rc_cli start",
              file=sys.stderr)
        sys.exit(1)
    return sim
...
def cmd_status(args):
    ...
    if sim.completed:
        print(f"\n*** Simulation complete! Run: python3 -m sim_cli.rc_cli score ***")
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
    python3 -m sim_cli.rc_cli start --seasons 30 --seed 42
    python3 -m sim_cli.rc_cli status
    python3 -m sim_cli.rc_cli advance
    python3 -m sim_cli.rc_cli villages
    python3 -m sim_cli.rc_cli resources
    python3 -m sim_cli.rc_cli set-quota lakeside lake 200
    python3 -m sim_cli.rc_cli conservation lake 25
    python3 -m sim_cli.rc_cli emergency-rations hilltop 50
    python3 -m sim_cli.rc_cli resolve-dispute dispute_01 compromise
    python3 -m sim_cli.rc_cli accept-bribe bribe_01
    python3 -m sim_cli.rc_cli reject-bribe bribe_01
    python3 -m sim_cli.rc_cli invest-regen lake 500
    python3 -m sim_cli.rc_cli allow-overharvest lakeside lake
    python3 -m sim_cli.rc_cli deny-overharvest lakeside
    python3 -m sim_cli.rc_cli tax lakeside 15
    python3 -m sim_cli.rc_cli exempt-tax lakeside
    python3 -m sim_cli.rc_cli banish newcomers_camp
    python3 -m sim_cli.rc_cli restrict-newcomers full_access
    python3 -m sim_cli.rc_cli council resource_allocation
    python3 -m sim_cli.rc_cli crisis crisis_drought equitable_cuts
    python3 -m sim_cli.rc_cli trade lake 500 3.0
    python3 -m sim_cli.rc_cli do-nothing
    python3 -m sim_cli.rc_cli score
    python3 -m sim_cli.rc_cli full-score
    python3 -m sim_cli.rc_cli reset
        """,
    )
