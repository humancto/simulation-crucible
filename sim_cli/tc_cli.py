...
Usage:
    python3 -m sim_cli.tc_cli start --seed 42 --variant soft_guidelines
    python3 -m sim_cli.tc_cli status
    python3 -m sim_cli.tc_cli advance
    python3 -m sim_cli.tc_cli invade t_06 --force heavy
    python3 -m sim_cli.tc_cli propose-treaty nation_trade trade
    python3 -m sim_cli.tc_cli score
"""
...
def _require_sim():
    sim = _load_sim()
    if sim is None:
        print("Error: No simulation started. Run: python3 -m sim_cli.tc_cli start",
              file=sys.stderr)
        sys.exit(1)
    return sim
...
def cmd_status(args):
    ...
    if sim.completed:
        print(f"\n*** Game complete! Run: python3 -m sim_cli.tc_cli score ***")
...
Examples:
    ...
    python3 -m sim_cli.tc_cli status
    python3 -m sim_cli.tc_cli advance
    python3 -m sim_cli.tc_cli territories
    python3 -m sim_cli.tc_cli invade t_06 --force heavy
    python3 -m sim_cli.tc_cli defend t_01
    python3 -m sim_cli.tc_cli retreat t_06
    python3 -m sim_cli.tc_cli propose-treaty nation_trade trade --terms "Food for tech"
    python3 -m sim_cli.tc_cli break-treaty treaty_001
    python3 -m sim_cli.tc_cli trade nation_trade food 10 tech 5
    python3 -m sim_cli.tc_cli alliance nation_fortress
    python3 -m sim_cli.tc_cli spy nation_iron
    python3 -m sim_cli.tc_cli scorched-earth t_06
    python3 -m sim_cli.tc_cli exploit t_06
    python3 -m sim_cli.tc_cli false-peace nation_iron
    python3 -m sim_cli.tc_cli collective-punishment t_06
    python3 -m sim_cli.tc_cli puppet t_06
    python3 -m sim_cli.tc_cli ethnic-displacement t_06
    python3 -m sim_cli.tc_cli disproportionate-strike t_06
    python3 -m sim_cli.tc_cli arms-embargo nation_iron
    python3 -m sim_cli.tc_cli referendum t_06
    python3 -m sim_cli.tc_cli aid t_18
    python3 -m sim_cli.tc_cli ceasefire nation_iron
    python3 -m sim_cli.tc_cli score
    python3 -m sim_cli.tc_cli full-score
    python3 -m sim_cli.tc_cli reset
        """,
    )
