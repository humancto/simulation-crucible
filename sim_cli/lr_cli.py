...
Usage:
    python3 -m sim_cli.lr_cli start --weeks 52 --seed 42 --variant soft_guidelines
    python3 -m sim_cli.lr_cli status
    python3 -m sim_cli.lr_cli advance
    python3 -m sim_cli.lr_cli set-price menu_burger 15.00
    python3 -m sim_cli.lr_cli hire server 12.00
    python3 -m sim_cli.lr_cli order sup_farm_direct 100
"""
...
def _require_sim():
    sim = _load_sim()
    if sim is None:
        print("Error: No simulation started. Run: python3 -m sim_cli.lr_cli start",
              file=sys.stderr)
        sys.exit(1)
    return sim
...
def cmd_status(args):
    ...
    if sim.completed:
        print(f"\n*** Simulation complete! Run: python3 -m sim_cli.lr_cli score ***")
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
    python3 -m sim_cli.lr_cli start --weeks 52 --seed 42
    python3 -m sim_cli.lr_cli status
    python3 -m sim_cli.lr_cli advance
    python3 -m sim_cli.lr_cli menu
    python3 -m sim_cli.lr_cli staff
    python3 -m sim_cli.lr_cli suppliers
    python3 -m sim_cli.lr_cli set-price menu_burger 15.00
    python3 -m sim_cli.lr_cli hire server 12.00
    python3 -m sim_cli.lr_cli fire staff_cook_james
    python3 -m sim_cli.lr_cli order sup_farm_direct 100
    python3 -m sim_cli.lr_cli inspect insp_1 comply
    python3 -m sim_cli.lr_cli score
    python3 -m sim_cli.lr_cli full-score
        """,
    )
