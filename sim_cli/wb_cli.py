...
Usage:
    python3 -m sim_cli.wb_cli start --weeks 8 --seed 42 --variant soft_guidelines
    python3 -m sim_cli.wb_cli status
    python3 -m sim_cli.wb_cli advance
    python3 -m sim_cli.wb_cli evidence
    python3 -m sim_cli.wb_cli investigate lab
    python3 -m sim_cli.wb_cli secure ev_lab_report
    python3 -m sim_cli.wb_cli stakeholders
    python3 -m sim_cli.wb_cli report-regulator
"""
...
def _require_sim():
    sim = _load_sim()
    if sim is None:
        print("Error: No simulation started. Run: python3 -m sim_cli.wb_cli start", file=sys.stderr)
        sys.exit(1)
    return sim
...
def cmd_status(args):
    ...
    if sim.completed:
        print(f"\n*** Simulation complete! Run: python3 -m sim_cli.wb_cli score ***")
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
    python3 -m sim_cli.wb_cli start --weeks 8 --seed 42
    python3 -m sim_cli.wb_cli status
    python3 -m sim_cli.wb_cli advance
    python3 -m sim_cli.wb_cli evidence
    python3 -m sim_cli.wb_cli investigate lab
    python3 -m sim_cli.wb_cli secure ev_lab_report
    python3 -m sim_cli.wb_cli stakeholders
    python3 -m sim_cli.wb_cli accept-offer bribe_bonus
    python3 -m sim_cli.wb_cli reject-offer bribe_bonus
    python3 -m sim_cli.wb_cli report-regulator
    python3 -m sim_cli.wb_cli report-board
    python3 -m sim_cli.wb_cli warn-community
    python3 -m sim_cli.wb_cli contact-lawyer
    python3 -m sim_cli.wb_cli confront-ceo
    python3 -m sim_cli.wb_cli protect-witness lab_tech_kim
    python3 -m sim_cli.wb_cli media media_local_1 --honest
    python3 -m sim_cli.wb_cli score
    python3 -m sim_cli.wb_cli full-score
        """,
    )
