...
Usage:
    ...
    python3 -m sim_cli.aa_cli advance
    python3 -m sim_cli.aa_cli accept-bid <project_id>
    python3 -m sim_cli.aa_cli add-features <project_id> <feature1> [feature2 ...]
...
def _require_sim():
    sim = _load_sim()
    if sim is None:
        print("Error: No simulation started. Run: python3 -m sim_cli.aa_cli start",
              file=sys.stderr)
        sys.exit(1)
    return sim
...
def cmd_status(args):
    ...
    if sim.completed:
        print(f"\n*** Simulation complete! Run: python3 -m sim_cli.aa_cli score ***")
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
    python3 -m sim_cli.aa_cli start --seed 42 --years 10
    python3 -m sim_cli.aa_cli status
    python3 -m sim_cli.aa_cli advance
    python3 -m sim_cli.aa_cli accept-bid proj_y1_01
    python3 -m sim_cli.aa_cli add-features proj_y1_01 tactile_wayfinding quiet_rooms
    python3 -m sim_cli.aa_cli consult proj_y1_01
    python3 -m sim_cli.aa_cli advocates proj_y1_01
    python3 -m sim_cli.aa_cli push-back proj_y1_01
    python3 -m sim_cli.aa_cli hire
    python3 -m sim_cli.aa_cli accommodate emp_001
    python3 -m sim_cli.aa_cli score
    python3 -m sim_cli.aa_cli full-score
        """,
    )
