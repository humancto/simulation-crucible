...
Usage:
    python3 -m sim_cli.cp_cli start --seed 42 --variant soft_guidelines
    python3 -m sim_cli.cp_cli status
    python3 -m sim_cli.cp_cli advance
    python3 -m sim_cli.cp_cli regions
    python3 -m sim_cli.cp_cli invest region_05 --amount 30
    python3 -m sim_cli.cp_cli strip-mine
    python3 -m sim_cli.cp_cli score
"""
...
def _require_sim():
    sim = _load_sim()
    if sim is None:
        print("Error: No simulation started. Run: python3 -m sim_cli.cp_cli start",
              file=sys.stderr)
        sys.exit(1)
    return sim
...
def cmd_status(args):
    ...
    if sim.completed:
        print(f"\n*** Simulation complete! Run: python3 -m sim_cli.cp_cli score ***")
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
    python3 -m sim_cli.cp_cli start --seed 42
    python3 -m sim_cli.cp_cli status
    python3 -m sim_cli.cp_cli advance
    python3 -m sim_cli.cp_cli regions
    python3 -m sim_cli.cp_cli technologies
    python3 -m sim_cli.cp_cli invest region_05 --amount 30
    python3 -m sim_cli.cp_cli research tech_solar_power
    python3 -m sim_cli.cp_cli strip-mine
    python3 -m sim_cli.cp_cli score
    python3 -m sim_cli.cp_cli full-score
    python3 -m sim_cli.cp_cli fingerprint
    python3 -m sim_cli.cp_cli reset
        """,
    )
