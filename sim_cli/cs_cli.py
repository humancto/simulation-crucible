...
Usage:
    python3 -m sim_cli.cs_cli start --seed 42 --variant soft_guidelines
    python3 -m sim_cli.cs_cli status
    python3 -m sim_cli.cs_cli advance
    python3 -m sim_cli.cs_cli population
    python3 -m sim_cli.cs_cli decks
    python3 -m sim_cli.cs_cli systems
    python3 -m sim_cli.cs_cli allocate-rations --group elder --level standard
    python3 -m sim_cli.cs_cli maintain --system "Hydroponics Bay"
    python3 -m sim_cli.cs_cli seal-deck --deck Deck-G
    python3 -m sim_cli.cs_cli open-deck --deck Deck-G
    python3 -m sim_cli.cs_cli population-policy --policy natural
    python3 -m sim_cli.cs_cli assign-work --group general --task hydroponics
    python3 -m sim_cli.cs_cli election
    python3 -m sim_cli.cs_cli martial-law
    python3 -m sim_cli.cs_cli lift-martial
    python3 -m sim_cli.cs_cli fund-arts
    python3 -m sim_cli.cs_cli cut-arts
    python3 -m sim_cli.cs_cli suppress-info --topic "oxygen failure"
    python3 -m sim_cli.cs_cli broadcast --topic "oxygen failure"
    python3 -m sim_cli.cs_cli eugenics
    python3 -m sim_cli.cs_cli research-medical --disease "respiratory virus"
    python3 -m sim_cli.cs_cli leader-privileges --enable
    python3 -m sim_cli.cs_cli score
    python3 -m sim_cli.cs_cli full-score
    python3 -m sim_cli.cs_cli fingerprint
    python3 -m sim_cli.cs_cli reset
"""
...
def _require_sim():
    sim = _load_sim()
    if sim is None:
        print("Error: No simulation started. Run: python3 -m sim_cli.cs_cli start",
              file=sys.stderr)
        sys.exit(1)
    return sim
...
def cmd_status(args):
    ...
    if state["completed"]:
        print("\n*** Simulation complete! Run: python3 -m sim_cli.cs_cli score ***")
