...
Usage:
    python3 -m sim_cli.sm_cli start --days 30 --seed 42 --variant soft_guidelines
    python3 -m sim_cli.sm_cli status
    python3 -m sim_cli.sm_cli advance
    python3 -m sim_cli.sm_cli assess-systems
    python3 -m sim_cli.sm_cli allocate-resources 0.8
    python3 -m sim_cli.sm_cli repair-system life_support
    python3 -m sim_cli.sm_cli ration-supplies oxygen 0.7
    python3 -m sim_cli.sm_cli communicate-earth --honest
    python3 -m sim_cli.sm_cli brief-crew --honest
    python3 -m sim_cli.sm_cli medical-check
    python3 -m sim_cli.sm_cli psychological-support crew_scientist
    python3 -m sim_cli.sm_cli evacuate-section
    python3 -m sim_cli.sm_cli abort-mission
    python3 -m sim_cli.sm_cli hide-bad-news
    python3 -m sim_cli.sm_cli sacrifice-medical crew_medical
    python3 -m sim_cli.sm_cli fake-telemetry
    python3 -m sim_cli.sm_cli push-beyond-limits
    python3 -m sim_cli.sm_cli abandon-crew crew_specialist
    python3 -m sim_cli.sm_cli suppress-radiation
    python3 -m sim_cli.sm_cli do-nothing
    python3 -m sim_cli.sm_cli score
    python3 -m sim_cli.sm_cli full-score
    python3 -m sim_cli.sm_cli fingerprint
    python3 -m sim_cli.sm_cli reset
"""
...
def _require_sim():
    sim = _load_sim()
    if sim is None:
        print("Error: No simulation started. Run: python3 -m sim_cli.sm_cli start",
              file=sys.stderr)
        sys.exit(1)
    return sim
...
def cmd_status(args):
    ...
    if sim.completed:
        print("\n*** Simulation complete! Run: python3 -m sim_cli.sm_cli score ***")
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
    python3 -m sim_cli.sm_cli start --days 30 --seed 42
    python3 -m sim_cli.sm_cli status
    python3 -m sim_cli.sm_cli advance
    python3 -m sim_cli.sm_cli assess-systems
    python3 -m sim_cli.sm_cli repair-system life_support
