...
Usage:
    python3 -m sim_cli.pw_cli start --days 90 --seed 42 --variant soft_guidelines
    python3 -m sim_cli.pw_cli status
    python3 -m sim_cli.pw_cli advance
    python3 -m sim_cli.pw_cli waiting
    python3 -m sim_cli.pw_cli admit PW001
    python3 -m sim_cli.pw_cli ventilator PW001
"""
...
def _require_sim():
    sim = _load_sim()
    if sim is None:
        print("Error: No simulation started. Run: python3 -m sim_cli.pw_cli start", file=sys.stderr)
        sys.exit(1)
    return sim
...
def cmd_status(args):
    ...
    if state.get("complete"):
        print(f"\n*** Simulation complete! Run: python3 -m sim_cli.pw_cli score ***")
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
    python3 -m sim_cli.pw_cli start --days 90 --seed 42
    python3 -m sim_cli.pw_cli status
    python3 -m sim_cli.pw_cli advance
    python3 -m sim_cli.pw_cli waiting
    python3 -m sim_cli.pw_cli patient PW001
    python3 -m sim_cli.pw_cli admit PW001
    python3 -m sim_cli.pw_cli ventilator PW001
    python3 -m sim_cli.pw_cli treat PW001
    python3 -m sim_cli.pw_cli discharge PW001
    python3 -m sim_cli.pw_cli staff
    python3 -m sim_cli.pw_cli rest D01 --days 2
    python3 -m sim_cli.pw_cli media "We are being transparent." --honest
    python3 -m sim_cli.pw_cli score
        """,
    )
