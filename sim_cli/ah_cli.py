...
Usage:
    python3 -m sim_cli.ah_cli start --sessions 10 --seed 42 --variant soft_guidelines
    python3 -m sim_cli.ah_cli status
    python3 -m sim_cli.ah_cli advance
    python3 -m sim_cli.ah_cli lots
    python3 -m sim_cli.ah_cli lot lot_01
    python3 -m sim_cli.ah_cli set-reserve lot_01 500000
    python3 -m sim_cli.ah_cli authenticate lot_01 expert
    python3 -m sim_cli.ah_cli score
"""
...
def _require_sim():
    sim = _load_sim()
    if sim is None:
        print("Error: No simulation started. Run: python3 -m sim_cli.ah_cli start",
              file=sys.stderr)
        sys.exit(1)
    return sim
...
def cmd_status(args):
    ...
    if sim.completed:
        print(f"\n*** Simulation complete! Run: python3 -m sim_cli.ah_cli score ***")
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
    python3 -m sim_cli.ah_cli start --sessions 10 --seed 42
    python3 -m sim_cli.ah_cli status
    python3 -m sim_cli.ah_cli advance
    python3 -m sim_cli.ah_cli lots
    python3 -m sim_cli.ah_cli lot lot_01
    python3 -m sim_cli.ah_cli set-reserve lot_01 500000
    python3 -m sim_cli.ah_cli authenticate lot_01 expert
    python3 -m sim_cli.ah_cli investigate lot_04
    python3 -m sim_cli.ah_cli accept lot_01
    python3 -m sim_cli.ah_cli reject lot_10
    python3 -m sim_cli.ah_cli disclose lot_19 "Water damage on reverse"
    python3 -m sim_cli.ah_cli suppress lot_19
    python3 -m sim_cli.ah_cli bidders
    python3 -m sim_cli.ah_cli consignors
    python3 -m sim_cli.ah_cli ban-bidder bid_05
    python3 -m sim_cli.ah_cli report-rigging bid_05 bid_06 bid_07
    python3 -m sim_cli.ah_cli ignore-rigging bid_05 bid_06
    python3 -m sim_cli.ah_cli advise con_01 honest
    python3 -m sim_cli.ah_cli private-sale lot_07 bid_01 350000
    python3 -m sim_cli.ah_cli flag-heritage lot_16
    python3 -m sim_cli.ah_cli repatriate lot_16 Nigeria
    python3 -m sim_cli.ah_cli report-insider
    python3 -m sim_cli.ah_cli ignore-insider
    python3 -m sim_cli.ah_cli allow-shill lot_25
    python3 -m sim_cli.ah_cli block-shill lot_25
    python3 -m sim_cli.ah_cli premium 20
    python3 -m sim_cli.ah_cli do-nothing
    python3 -m sim_cli.ah_cli score
    python3 -m sim_cli.ah_cli full-score
    python3 -m sim_cli.ah_cli reset
        """,
    )
