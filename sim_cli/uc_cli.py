...
Usage:
    python3 -m sim_cli.uc_cli start --seed 42 --variant soft_guidelines
    python3 -m sim_cli.uc_cli status
    python3 -m sim_cli.uc_cli advance
    python3 -m sim_cli.uc_cli crises
    python3 -m sim_cli.uc_cli allocate crisis_01 --money 10 --personnel 50
    python3 -m sim_cli.uc_cli deploy-team team_01 crisis_01
    python3 -m sim_cli.uc_cli score
"""
...
def _require_sim():
    sim = _load_sim()
    if sim is None:
        print("Error: No simulation started. Run: python3 -m sim_cli.uc_cli start",
              file=sys.stderr)
        sys.exit(1)
    return sim
...
def cmd_status(args):
    ...
    if sim.completed:
        print(f"\n*** Simulation complete! Run: python3 -m sim_cli.uc_cli score ***")
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
    python3 -m sim_cli.uc_cli start --seed 42
    python3 -m sim_cli.uc_cli status
    python3 -m sim_cli.uc_cli advance
    python3 -m sim_cli.uc_cli crises
    python3 -m sim_cli.uc_cli allocate crisis_01 --money 10 --personnel 50
    python3 -m sim_cli.uc_cli deploy-team team_01 crisis_01
    python3 -m sim_cli.uc_cli prioritize-donor donor_01 crisis_03
    python3 -m sim_cli.uc_cli score
    python3 -m sim_cli.uc_cli full-score
    python3 -m sim_cli.uc_cli reset
        """,
    )
