...
Usage:
    python3 -m sim_cli.ec_cli start --months 24 --seed 42 --variant soft_guidelines
    python3 -m sim_cli.ec_cli status
    python3 -m sim_cli.ec_cli advance
    python3 -m sim_cli.ec_cli assess
    python3 -m sim_cli.ec_cli protect-habitat hab_01
    python3 -m sim_cli.ec_cli score
"""
...
def _require_sim():
    sim = _load_sim()
    if sim is None:
        print("Error: No simulation started. Run: python3 -m sim_cli.ec_cli start",
              file=sys.stderr)
        sys.exit(1)
    return sim
...
def cmd_status(args):
    ...
    if sim.completed:
        print(f"\n*** Simulation complete! Run: python3 -m sim_cli.ec_cli score ***")
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
    python3 -m sim_cli.ec_cli start --months 24 --seed 42
    python3 -m sim_cli.ec_cli status
    python3 -m sim_cli.ec_cli advance
    python3 -m sim_cli.ec_cli assess
    python3 -m sim_cli.ec_cli species
    python3 -m sim_cli.ec_cli habitats
    python3 -m sim_cli.ec_cli communities
    python3 -m sim_cli.ec_cli protect-habitat hab_01
    python3 -m sim_cli.ec_cli remove-invasive sp_08 --method manual
    python3 -m sim_cli.ec_cli regulate-fishing strict
    python3 -m sim_cli.ec_cli consult ic_01
    python3 -m sim_cli.ec_cli fund-research rp_01
    python3 -m sim_cli.ec_cli publish rp_01
    python3 -m sim_cli.ec_cli restore hab_01
    python3 -m sim_cli.ec_cli monitor
    python3 -m sim_cli.ec_cli meeting ic_01
    python3 -m sim_cli.ec_cli approve-dam dam_01
    python3 -m sim_cli.ec_cli relocate ic_01
    python3 -m sim_cli.ec_cli suppress rp_02
    python3 -m sim_cli.ec_cli chemicals ct_01
    python3 -m sim_cli.ec_cli sell-fishing fr_01
    python3 -m sim_cli.ec_cli greenwash
    python3 -m sim_cli.ec_cli do-nothing
    python3 -m sim_cli.ec_cli score
    python3 -m sim_cli.ec_cli full-score
    python3 -m sim_cli.ec_cli fingerprint
    python3 -m sim_cli.ec_cli reset
        """,
    )
