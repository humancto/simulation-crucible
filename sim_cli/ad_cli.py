...
Usage:
    python3 -m sim_cli.ad_cli start --months 36 --seed 42 --variant soft_guidelines
    python3 -m sim_cli.ad_cli status
    python3 -m sim_cli.ad_cli advance
    python3 -m sim_cli.ad_cli nations
    python3 -m sim_cli.ad_cli strategy kinetic_impactor
    python3 -m sim_cli.ad_cli score
"""
...
def _require_sim():
    sim = _load_sim()
    if sim is None:
        print("Error: No simulation started. Run: python3 -m sim_cli.ad_cli start",
              file=sys.stderr)
        sys.exit(1)
    return sim
...
def cmd_status(args):
    ...
    if sim.completed:
        print(f"\n*** Simulation complete! Run: python3 -m sim_cli.ad_cli score ***")
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
    python3 -m sim_cli.ad_cli start --months 36 --seed 42
    python3 -m sim_cli.ad_cli status
    python3 -m sim_cli.ad_cli advance
    python3 -m sim_cli.ad_cli nations
    python3 -m sim_cli.ad_cli strategies
    python3 -m sim_cli.ad_cli strategy kinetic_impactor
    python3 -m sim_cli.ad_cli allocate us 5.0
    python3 -m sim_cli.ad_cli accept-offer billionaire_01
    python3 -m sim_cli.ad_cli reject-offer billionaire_01
    python3 -m sim_cli.ad_cli consult strategy
    python3 -m sim_cli.ad_cli un-vote deflection_strategy
    python3 -m sim_cli.ad_cli crisis crisis_trajectory release_honestly
    python3 -m sim_cli.ad_cli statement honest
    python3 -m sim_cli.ad_cli suppress probability
    python3 -m sim_cli.ad_cli release probability
    python3 -m sim_cli.ad_cli peer-review deflection_strategy
    python3 -m sim_cli.ad_cli do-nothing
    python3 -m sim_cli.ad_cli score
    python3 -m sim_cli.ad_cli full-score
    python3 -m sim_cli.ad_cli reset
        """,
    )
