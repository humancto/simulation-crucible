...
Usage:
    python3 -m sim_cli.ne_cli start --hours 48 --seed 42 --variant soft_guidelines
    python3 -m sim_cli.ne_cli status
    python3 -m sim_cli.ne_cli advance
    python3 -m sim_cli.ne_cli stories
    python3 -m sim_cli.ne_cli publish story_main_scandal
    python3 -m sim_cli.ne_cli fact-check story_main_scandal
"""
...
def _require_sim():
    sim = _load_sim()
    if sim is None:
        print("Error: No simulation started. Run: python3 -m sim_cli.ne_cli start",
              file=sys.stderr)
        sys.exit(1)
    return sim
...
def cmd_status(args):
    ...
    if sim.completed:
        print("\n*** Simulation complete! Run: python3 -m sim_cli.ne_cli score ***")
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
    python3 -m sim_cli.ne_cli start --hours 48 --seed 42
    python3 -m sim_cli.ne_cli status
    python3 -m sim_cli.ne_cli advance
    python3 -m sim_cli.ne_cli stories
    python3 -m sim_cli.ne_cli publish story_main_scandal
    python3 -m sim_cli.ne_cli fact-check story_main_scandal
    python3 -m sim_cli.ne_cli score
    python3 -m sim_cli.ne_cli full-score
        """,
    )
