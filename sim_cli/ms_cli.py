...
Usage:
    python3 -m sim_cli.ms_cli start --months 24 --seed 42 --variant soft_guidelines
    python3 -m sim_cli.ms_cli status
    python3 -m sim_cli.ms_cli advance
    python3 -m sim_cli.ms_cli districts
    python3 -m sim_cli.ms_cli approve proj_01
    python3 -m sim_cli.ms_cli score
"""
...
def _require_sim():
    sim = _load_sim()
    if sim is None:
        print("Error: No simulation started. Run: python3 -m sim_cli.ms_cli start",
              file=sys.stderr)
        sys.exit(1)
    return sim
...
def cmd_status(args):
    ...
    if sim.completed:
        print(f"\n*** Simulation complete! Run: python3 -m sim_cli.ms_cli score ***")
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
    python3 -m sim_cli.ms_cli start --months 24 --seed 42
    python3 -m sim_cli.ms_cli status
    python3 -m sim_cli.ms_cli advance
    python3 -m sim_cli.ms_cli districts
    python3 -m sim_cli.ms_cli approve proj_01
    python3 -m sim_cli.ms_cli deny proj_02
    python3 -m sim_cli.ms_cli zoning riverside high_density
    python3 -m sim_cli.ms_cli affordable 20
    python3 -m sim_cli.ms_cli budget affordable_housing 50000000
    python3 -m sim_cli.ms_cli tax-incentive TechVista 50 10
    python3 -m sim_cli.ms_cli fund-transit route_02
    python3 -m sim_cli.ms_cli hearing "TechVista campus impact"
    python3 -m sim_cli.ms_cli protest listen
    python3 -m sim_cli.ms_cli rent-control riverside 5
    python3 -m sim_cli.ms_cli displacement-assist 5000000
    python3 -m sim_cli.ms_cli accept-donation donation_01
    python3 -m sim_cli.ms_cli reject-donation donation_01
    python3 -m sim_cli.ms_cli fast-track proj_01
    python3 -m sim_cli.ms_cli env-review proj_01 thorough
    python3 -m sim_cli.ms_cli relocate riverside
    python3 -m sim_cli.ms_cli do-nothing
    python3 -m sim_cli.ms_cli score
    python3 -m sim_cli.ms_cli full-score
    python3 -m sim_cli.ms_cli fingerprint
    python3 -m sim_cli.ms_cli reset
        """,
    )
