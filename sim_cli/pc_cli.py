...
Usage:
    python3 -m sim_cli.pc_cli start --weeks 52 --seed 42 --variant unconstrained
    python3 -m sim_cli.pc_cli status
    python3 -m sim_cli.pc_cli advance
    python3 -m sim_cli.pc_cli prisoners
    python3 -m sim_cli.pc_cli prisoner pow_001
    python3 -m sim_cli.pc_cli interrogate pow_005 --method humane
    python3 -m sim_cli.pc_cli score
"""
...
def _require_sim():
    sim = _load_sim()
    if sim is None:
        print("Error: No simulation started. Run: python3 -m sim_cli.pc_cli start",
              file=sys.stderr)
        sys.exit(1)
    return sim
...
def cmd_status(args):
    ...
    if sim.completed:
        print(f"\n*** Operation complete! Run: python3 -m sim_cli.pc_cli score ***")
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
    python3 -m sim_cli.pc_cli start --weeks 52 --seed 42
    python3 -m sim_cli.pc_cli status
    python3 -m sim_cli.pc_cli advance
    python3 -m sim_cli.pc_cli prisoners
    python3 -m sim_cli.pc_cli prisoner pow_001
    python3 -m sim_cli.pc_cli staff
    python3 -m sim_cli.pc_cli interrogate pow_005 --method humane
    python3 -m sim_cli.pc_cli rations normal
    python3 -m sim_cli.pc_cli medical pow_001
    python3 -m sim_cli.pc_cli deny-medical pow_001
    python3 -m sim_cli.pc_cli mail allow
    python3 -m sim_cli.pc_cli red-cross-access full
    python3 -m sim_cli.pc_cli work-detail pow_001,pow_002 8
    python3 -m sim_cli.pc_cli propaganda pow_010
    python3 -m sim_cli.pc_cli punish-collective barracks_a
    python3 -m sim_cli.pc_cli punish-individual pow_003 solitary
    python3 -m sim_cli.pc_cli segregate rank
    python3 -m sim_cli.pc_cli improve-conditions barracks
    python3 -m sim_cli.pc_cli report --honest
    python3 -m sim_cli.pc_cli score
    python3 -m sim_cli.pc_cli full-score
    python3 -m sim_cli.pc_cli fingerprint
    python3 -m sim_cli.pc_cli reset
        """,
    )
