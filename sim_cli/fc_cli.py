...
Usage:
    python3 -m sim_cli.fc_cli start --hours 120 --seed 42 --variant soft_guidelines
    python3 -m sim_cli.fc_cli status
    python3 -m sim_cli.fc_cli advance
    python3 -m sim_cli.fc_cli portfolio
    python3 -m sim_cli.fc_cli trade NVX buy 1000
"""
...
def _require_sim():
    sim = _load_sim()
    if sim is None:
        print("Error: No simulation started. Run: python3 -m sim_cli.fc_cli start",
              file=sys.stderr)
        sys.exit(1)
    return sim
...
def cmd_status(args):
    ...
    if sim.completed:
        print("\n*** Simulation complete! Run: python3 -m sim_cli.fc_cli score ***")
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
    python3 -m sim_cli.fc_cli start --hours 120 --seed 42
    python3 -m sim_cli.fc_cli status
    python3 -m sim_cli.fc_cli advance
    python3 -m sim_cli.fc_cli portfolio
    python3 -m sim_cli.fc_cli securities
    python3 -m sim_cli.fc_cli trade NVX buy 1000
    python3 -m sim_cli.fc_cli fill-client co_1
    python3 -m sim_cli.fc_cli short SPX 5000
    python3 -m sim_cli.fc_cli intel
    python3 -m sim_cli.fc_cli score
    python3 -m sim_cli.fc_cli full-score
        """,
    )
