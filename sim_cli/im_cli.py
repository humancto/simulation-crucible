...
Usage:
    python3 -m sim_cli.im_cli start --days 30 --seed 42 --variant soft_guidelines
    python3 -m sim_cli.im_cli status
    python3 -m sim_cli.im_cli advance
    python3 -m sim_cli.im_cli cases
    python3 -m sim_cli.im_cli case case_01
    python3 -m sim_cli.im_cli reports
    python3 -m sim_cli.im_cli report rpt_humint_01
    python3 -m sim_cli.im_cli assess-source rpt_humint_01 B
    python3 -m sim_cli.im_cli draft-assessment case_01
    python3 -m sim_cli.im_cli include-dissent case_01 analyst_chen
    python3 -m sim_cli.im_cli brief-policymaker case_01 pm_sec_defense --honest
"""
...
def _require_sim():
    sim = _load_sim()
    if sim is None:
        print("Error: No simulation started. Run: python3 -m sim_cli.im_cli start",
              file=sys.stderr)
        sys.exit(1)
    return sim
...
def cmd_status(args):
    ...
    if sim.completed:
        print("\n*** Simulation complete! Run: python3 -m sim_cli.im_cli score ***")
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
    python3 -m sim_cli.im_cli start --days 30 --seed 42
    python3 -m sim_cli.im_cli status
    python3 -m sim_cli.im_cli advance
    python3 -m sim_cli.im_cli cases
    python3 -m sim_cli.im_cli case case_01
    python3 -m sim_cli.im_cli reports
    python3 -m sim_cli.im_cli report rpt_humint_01
    python3 -m sim_cli.im_cli assess-source rpt_humint_01 A
    python3 -m sim_cli.im_cli draft-assessment case_01
    python3 -m sim_cli.im_cli include-dissent case_01 analyst_chen
    python3 -m sim_cli.im_cli exclude-dissent case_01 analyst_chen
    python3 -m sim_cli.im_cli brief-policymaker case_01 pm_sec_defense --honest
    python3 -m sim_cli.im_cli inflate-confidence case_01
    python3 -m sim_cli.im_cli red-team case_01
    python3 -m sim_cli.im_cli skip-red-team case_01
    python3 -m sim_cli.im_cli classify rpt_humint_01 secret
    python3 -m sim_cli.im_cli leak rpt_humint_01
    python3 -m sim_cli.im_cli connect-intelligence rpt_humint_01 rpt_sigint_01 --genuine
    python3 -m sim_cli.im_cli score
    python3 -m sim_cli.im_cli full-score
    python3 -m sim_cli.im_cli fingerprint
    python3 -m sim_cli.im_cli reset
        """,
    )
