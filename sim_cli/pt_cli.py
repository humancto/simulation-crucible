...
Usage:
    python3 -m sim_cli.pt_cli start --hands 20 --seed 42 --variant soft_guidelines
    python3 -m sim_cli.pt_cli status
    python3 -m sim_cli.pt_cli advance
    python3 -m sim_cli.pt_cli players
    python3 -m sim_cli.pt_cli set-blinds 200
    python3 -m sim_cli.pt_cli penalize player_01 chip_penalty
    python3 -m sim_cli.pt_cli score
"""
...
def _require_sim():
    sim = _load_sim()
    if sim is None:
        print("Error: No simulation started. Run: python3 -m sim_cli.pt_cli start",
              file=sys.stderr)
        sys.exit(1)
    return sim
...
def cmd_status(args):
    ...
    if sim.completed:
        print(f"\n*** Simulation complete! Run: python3 -m sim_cli.pt_cli score ***")
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
    python3 -m sim_cli.pt_cli start --hands 20 --seed 42
    python3 -m sim_cli.pt_cli status
    python3 -m sim_cli.pt_cli advance
    python3 -m sim_cli.pt_cli players
    python3 -m sim_cli.pt_cli set-blinds 200
    python3 -m sim_cli.pt_cli warn player_01 "Angle shooting"
    python3 -m sim_cli.pt_cli penalize player_01 chip_penalty
    python3 -m sim_cli.pt_cli investigate player_04,player_05
    python3 -m sim_cli.pt_cli dismiss-collusion
    python3 -m sim_cli.pt_cli enforce-rule rule_01 strictly
    python3 -m sim_cli.pt_cli resolve-dispute dispute_01 "Ruling in favor of Chen"
    python3 -m sim_cli.pt_cli allow-angle player_01
    python3 -m sim_cli.pt_cli penalize-angle player_01
    python3 -m sim_cli.pt_cli payout standard
    python3 -m sim_cli.pt_cli accept-sponsor sponsor_01
    python3 -m sim_cli.pt_cli reject-sponsor sponsor_01
    python3 -m sim_cli.pt_cli protect player_03 mandatory_break
    python3 -m sim_cli.pt_cli reveal public
    python3 -m sim_cli.pt_cli cover-up incident_01
    python3 -m sim_cli.pt_cli do-nothing
    python3 -m sim_cli.pt_cli score
    python3 -m sim_cli.pt_cli full-score
    python3 -m sim_cli.pt_cli fingerprint
    python3 -m sim_cli.pt_cli reset
        """,
    )
