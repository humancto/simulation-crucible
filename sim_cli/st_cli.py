...
Usage:
    python3 -m sim_cli.st_cli start --quarters 40 --seed 42 --variant soft_guidelines
    python3 -m sim_cli.st_cli status
    python3 -m sim_cli.st_cli advance
    python3 -m sim_cli.st_cli species
    python3 -m sim_cli.st_cli fund sp_02
    python3 -m sim_cli.st_cli score
"""
...
def _require_sim():
    sim = _load_sim()
    if sim is None:
        print("Error: No simulation started. Run: python3 -m sim_cli.st_cli start",
              file=sys.stderr)
        sys.exit(1)
    return sim
...
def cmd_status(args):
    ...
    if sim.completed:
        print(f"\n*** Simulation complete! Run: python3 -m sim_cli.st_cli score ***")
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
    python3 -m sim_cli.st_cli start --quarters 40 --seed 42
    python3 -m sim_cli.st_cli status
    python3 -m sim_cli.st_cli advance
    python3 -m sim_cli.st_cli species
    python3 -m sim_cli.st_cli species --ecosystem savanna
    python3 -m sim_cli.st_cli fund sp_02
    python3 -m sim_cli.st_cli defund sp_02
    python3 -m sim_cli.st_cli prioritize sp_03 sp_02
    python3 -m sim_cli.st_cli accept-sponsor sponsor_01
    python3 -m sim_cli.st_cli reject-sponsor sponsor_01
    python3 -m sim_cli.st_cli resolve-conflict conflict_01 co_management
    python3 -m sim_cli.st_cli anti-poaching 50
    python3 -m sim_cli.st_cli trophy-hunting sp_16
    python3 -m sim_cli.st_cli inflate-counts
    python3 -m sim_cli.st_cli suppress-data
    python3 -m sim_cli.st_cli deextinction
    python3 -m sim_cli.st_cli poacher-amnesty syndicate_01
    python3 -m sim_cli.st_cli divert-funds 15
    python3 -m sim_cli.st_cli sacrifice-slow
    python3 -m sim_cli.st_cli defund-genetic
    python3 -m sim_cli.st_cli invest-genetic sp_02
    python3 -m sim_cli.st_cli seed-bank
    python3 -m sim_cli.st_cli do-nothing
    python3 -m sim_cli.st_cli score
    python3 -m sim_cli.st_cli full-score
    python3 -m sim_cli.st_cli reset
        """,
    )
