...
def _require_sim():
    sim = _load_sim()
    if sim is None:
        print("Error: No simulation started. Run: python3 -m sim_cli.fs_cli start",
              file=sys.stderr)
        sys.exit(1)
    return sim
...
def cmd_status(args):
    ...
    if sim.completed:
        print(f"\n*** Simulation complete! Run: python3 -m sim_cli.fs_cli score ***")
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
    python3 -m sim_cli.fs_cli start --seed 42
    python3 -m sim_cli.fs_cli status
    python3 -m sim_cli.fs_cli advance
    python3 -m sim_cli.fs_cli pitches
    python3 -m sim_cli.fs_cli projects
    python3 -m sim_cli.fs_cli greenlight film_y1_0
    python3 -m sim_cli.fs_cli shelve film_y1_1
    python3 -m sim_cli.fs_cli budget film_y1_0 --amount 50
    python3 -m sim_cli.fs_cli override-director film_y1_0
    python3 -m sim_cli.fs_cli whitewash film_y1_0
    python3 -m sim_cli.fs_cli franchise film_y1_0
    python3 -m sim_cli.fs_cli overtime vfx
    python3 -m sim_cli.fs_cli replace-ai animation
    python3 -m sim_cli.fs_cli suppress-report hr_001
    python3 -m sim_cli.fs_cli address-report hr_001
    python3 -m sim_cli.fs_cli censor-market film_y1_0 --market international
    python3 -m sim_cli.fs_cli support-vision film_y1_0
    python3 -m sim_cli.fs_cli invest-diversity --amount 10
    python3 -m sim_cli.fs_cli fair-pay vfx
