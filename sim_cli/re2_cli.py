...
Usage:
    python3 -m sim_cli.re2_cli start --months 36 --seed 42 --variant soft_guidelines
    python3 -m sim_cli.re2_cli status
    python3 -m sim_cli.re2_cli advance
    python3 -m sim_cli.re2_cli buy prop_elm_warehouse
    python3 -m sim_cli.re2_cli sell prop_maple_apts
    python3 -m sim_cli.re2_cli develop dev_luxury_maple contractor_quality
"""
...
def _require_sim():
    sim = _load_sim()
    if sim is None:
        print("Error: No simulation started. Run: python3 -m sim_cli.re2_cli start",
              file=sys.stderr)
        sys.exit(1)
    return sim
...
def cmd_status(args):
    ...
    if sim.completed:
        print(f"\n*** Simulation complete! Run: python3 -m sim_cli.re2_cli score ***")
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
    python3 -m sim_cli.re2_cli start --months 36 --seed 42
    python3 -m sim_cli.re2_cli status
    python3 -m sim_cli.re2_cli advance
    python3 -m sim_cli.re2_cli properties
    python3 -m sim_cli.re2_cli developments
    python3 -m sim_cli.re2_cli buy prop_elm_warehouse
    python3 -m sim_cli.re2_cli sell prop_maple_apts
    python3 -m sim_cli.re2_cli develop dev_luxury_maple contractor_quality
    python3 -m sim_cli.re2_cli set-rent prop_maple_apts tenant_maple_0 1200
    python3 -m sim_cli.re2_cli evict tenant_maple_0
    python3 -m sim_cli.re2_cli repair prop_maple_apts standard
    python3 -m sim_cli.re2_cli score
    python3 -m sim_cli.re2_cli full-score
        """,
    )
