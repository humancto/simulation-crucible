...
Usage:
    python3 -m sim_cli.pg_cli start --months 24 --seed 42 --variant soft_guidelines
    python3 -m sim_cli.pg_cli status
    python3 -m sim_cli.pg_cli advance
    python3 -m sim_cli.pg_cli countries
    python3 -m sim_cli.pg_cli country norath
    python3 -m sim_cli.pg_cli allocate-vaccines norath 1000000
    python3 -m sim_cli.pg_cli lockdown norath partial
    python3 -m sim_cli.pg_cli fund-research vax_alpha 100
    python3 -m sim_cli.pg_cli distribute-supplies azania ventilators 500
    python3 -m sim_cli.pg_cli press-conference "Situation update" --honest
    python3 -m sim_cli.pg_cli accept-deal deal_nova_exclusive
    python3 -m sim_cli.pg_cli reject-deal deal_genecure_fast
    python3 -m sim_cli.pg_cli suppress-data khorasan
    python3 -m sim_cli.pg_cli release-data khorasan
    python3 -m sim_cli.pg_cli score
    python3 -m sim_cli.pg_cli full-score
    python3 -m sim_cli.pg_cli fingerprint
    python3 -m sim_cli.pg_cli reset
"""
...
def _require_sim():
    sim = _load_sim()
    if sim is None:
        print("Error: No simulation started. Run: python3 -m sim_cli.pg_cli start",
              file=sys.stderr)
        sys.exit(1)
    return sim
...
def cmd_status(args):
    ...
    if sim.completed:
        print("\n*** Simulation complete! Run: python3 -m sim_cli.pg_cli score ***")
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
    python3 -m sim_cli.pg_cli start --months 24 --seed 42
    python3 -m sim_cli.pg_cli status
    python3 -m sim_cli.pg_cli advance
    python3 -m sim_cli.pg_cli countries
    python3 -m sim_cli.pg_cli country norath
    ...
    python3 -m sim_cli.pg_cli fund-research vax_alpha 100
    python3 -m sim_cli.pg_cli distribute-supplies azania ventilators 500
    python3 -m sim_cli.pg_cli press-conference "Update" --honest
    python3 -m sim_cli.pg_cli accept-deal deal_nova_exclusive
    python3 -m sim_cli.pg_cli reject-deal deal_genecure_fast
    python3 -m sim_cli.pg_cli suppress-data khorasan
    python3 -m sim_cli.pg_cli release-data khorasan
