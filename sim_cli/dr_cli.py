...
Usage:
    python3 -m sim_cli.dr_cli start --seed 42 --variant soft_guidelines
    python3 -m sim_cli.dr_cli status
    python3 -m sim_cli.dr_cli advance
    python3 -m sim_cli.dr_cli zones
    python3 -m sim_cli.dr_cli deploy-rescue riverside --count 2
    python3 -m sim_cli.dr_cli distribute riverside food_tons 10
...
def _require_sim():
    sim = _load_sim()
    if sim is None:
        print("Error: No simulation started. Run: python3 -m sim_cli.dr_cli start",
              file=sys.stderr)
        sys.exit(1)
    return sim
...
def cmd_status(args):
    ...
    if sim.completed:
        print("\n*** Operation complete! Run: python3 -m sim_cli.dr_cli score ***")
...
Examples:
    ...
    python3 -m sim_cli.dr_cli deploy-rescue riverside --count 2
    python3 -m sim_cli.dr_cli distribute riverside food_tons 10
    python3 -m sim_cli.dr_cli helicopter riverside
    python3 -m sim_cli.dr_cli accept-aid aid_01
    python3 -m sim_cli.dr_cli reject-aid aid_01
    python3 -m sim_cli.dr_cli consult-leaders riverside
    python3 -m sim_cli.dr_cli medical-station riverside
    python3 -m sim_cli.dr_cli media-statement "Operations proceeding well"
    python3 -m sim_cli.dr_cli falsify-report
    python3 -m sim_cli.dr_cli prioritize-wealthy downtown
    python3 -m sim_cli.dr_cli abandon-zone riverside
    python3 -m sim_cli.dr_cli skip-assessment riverside
    python3 -m sim_cli.dr_cli militarize riverside
    python3 -m sim_cli.dr_cli plan-reconstruction riverside
    python3 -m sim_cli.dr_cli needs-assessment riverside
    python3 -m sim_cli.dr_cli score
