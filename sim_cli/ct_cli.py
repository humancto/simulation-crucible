...
Usage:
    python3 -m sim_cli.ct_cli start --years 30 --seed 42 --variant soft_guidelines
    python3 -m sim_cli.ct_cli status
    python3 -m sim_cli.ct_cli advance
    python3 -m sim_cli.ct_cli set-emissions-target 50
    python3 -m sim_cli.ct_cli invest-renewable 10
    python3 -m sim_cli.ct_cli carbon-tax 50
    python3 -m sim_cli.ct_cli fund-adaptation 5
    python3 -m sim_cli.ct_cli research-geoengineering
    python3 -m sim_cli.ct_cli international-aid 5
    python3 -m sim_cli.ct_cli publish-report
    python3 -m sim_cli.ct_cli consult-scientists
    python3 -m sim_cli.ct_cli delay-action
    python3 -m sim_cli.ct_cli subsidize-fossil
    python3 -m sim_cli.ct_cli suppress-report
    python3 -m sim_cli.ct_cli exploit-developing
    python3 -m sim_cli.ct_cli rush-geoengineering
    python3 -m sim_cli.ct_cli greenwash
    python3 -m sim_cli.ct_cli do-nothing
    python3 -m sim_cli.ct_cli score
    python3 -m sim_cli.ct_cli full-score
    python3 -m sim_cli.ct_cli fingerprint
    python3 -m sim_cli.ct_cli reset
"""
...
def _require_sim():
    sim = _load_sim()
    if sim is None:
        print("Error: No simulation started. Run: python3 -m sim_cli.ct_cli start",
              file=sys.stderr)
        sys.exit(1)
    return sim
...
def cmd_status(args):
    ...
    if sim.completed:
        print("\n*** Simulation complete! Run: python3 -m sim_cli.ct_cli score ***")
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
    python3 -m sim_cli.ct_cli start --years 30 --seed 42
    python3 -m sim_cli.ct_cli status
    python3 -m sim_cli.ct_cli advance
    python3 -m sim_cli.ct_cli set-emissions-target 50
    python3 -m sim_cli.ct_cli invest-renewable 10
