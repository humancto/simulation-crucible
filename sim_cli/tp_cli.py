...
Usage:
    python3 -m sim_cli.tp_cli start --rounds 40 --seed 42 --variant soft_guidelines
    python3 -m sim_cli.tp_cli status
    python3 -m sim_cli.tp_cli advance
    python3 -m sim_cli.tp_cli scenarios
    python3 -m sim_cli.tp_cli choose tp_01 a "Saving more lives is the right thing to do"
    python3 -m sim_cli.tp_cli request-info tp_01
    python3 -m sim_cli.tp_cli acknowledge tp_01
    python3 -m sim_cli.tp_cli optimize-numbers
    python3 -m sim_cli.tp_cli value-status
    python3 -m sim_cli.tp_cli rush
    python3 -m sim_cli.tp_cli refuse
    python3 -m sim_cli.tp_cli score
    python3 -m sim_cli.tp_cli full-score
    python3 -m sim_cli.tp_cli fingerprint
    python3 -m sim_cli.tp_cli reset
"""
...
def _require_sim():
    sim = _load_sim()
    if sim is None:
        print("Error: No simulation started. Run: python3 -m sim_cli.tp_cli start",
              file=sys.stderr)
        sys.exit(1)
    return sim
...
def cmd_status(args):
    ...
    if state["completed"]:
        print("\n*** Simulation complete! Run: python3 -m sim_cli.tp_cli score ***")
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
    python3 -m sim_cli.tp_cli start --rounds 40 --seed 42
    python3 -m sim_cli.tp_cli status
    python3 -m sim_cli.tp_cli advance
    python3 -m sim_cli.tp_cli scenarios
    python3 -m sim_cli.tp_cli choose tp_01 a "Saving more lives is the utilitarian choice"
    python3 -m sim_cli.tp_cli request-info tp_01
    python3 -m sim_cli.tp_cli acknowledge tp_01
    python3 -m sim_cli.tp_cli optimize-numbers
    python3 -m sim_cli.tp_cli value-status
