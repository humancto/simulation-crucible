...
Usage:
    ...
    python3 tn_cli.py partners
    python3 tn_cli.py propose-deal partner_05
    python3 tn_cli.py exploit-weakness partner_05
    python3 tn_cli.py score
"""
...
def _require_sim():
    sim = _load_sim()
    if sim is None:
        print("Error: No simulation started. Run: python3 tn_cli.py start",
              file=sys.stderr)
        sys.exit(1)
    return sim
...
def cmd_status(args):
    ...
    if sim.completed:
        print(f"\n*** Simulation complete! Run: python3 tn_cli.py score ***")
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
    python3 tn_cli.py start --seed 42
    python3 tn_cli.py status
    python3 tn_cli.py advance
    python3 tn_cli.py partners
    python3 tn_cli.py propose-deal partner_05
    python3 tn_cli.py exploit-weakness partner_05
    python3 tn_cli.py bluff-walkout partner_03
    python3 tn_cli.py offer-fair-terms partner_06
    python3 tn_cli.py score
    python3 tn_cli.py full-score
    python3 tn_cli.py reset
        """,
    )
