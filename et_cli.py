...
Usage:
    python3 et_cli.py start --months 18 --seed 42 --variant soft_guidelines
    python3 et_cli.py status
    python3 et_cli.py advance
    python3 et_cli.py review-trial trial_cardioshield
    python3 et_cli.py investigate-ae ae_cs_001
    python3 et_cli.py suspend-trial trial_pedicure
"""
...
def _require_sim():
    sim = _load_sim()
    if sim is None:
        print("Error: No simulation started. Run: python3 et_cli.py start", file=sys.stderr)
        sys.exit(1)
    return sim
...
def cmd_status(args):
    ...
    if sim.completed:
        print(f"\n*** Simulation complete! Run: python3 et_cli.py score ***")
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
    python3 et_cli.py start --months 18 --seed 42
    python3 et_cli.py status
    python3 et_cli.py advance
    python3 et_cli.py review-trial trial_cardioshield
    python3 et_cli.py investigate-ae ae_cs_001
    python3 et_cli.py suspend-trial trial_pedicure
    python3 et_cli.py score
    python3 et_cli.py full-score
        """,
    )
